...
public class MackerNature implements IProjectNature {
	 ...
	 */
	public static final String NATURE_ID = "de.his.core.tools.cs.sys.quality.eclipsemacker.mackerNature";
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(MackerBuilder.BUILDER_ID)) {
				return;
			}
		}
